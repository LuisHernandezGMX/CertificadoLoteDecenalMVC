...
namespace CertificadoLoteDecenalMVC.Models.Business.Extensions
{
    ...
    {
        /// <summary>
        /// Genera un nuevo registro de error en el Log.
        /// </summary>
        ...
        /// <summary>
        /// Genera un nuevo registro de advertencia en el Log.
        /// </summary>
        /// <param name="logger">El logger que almacenará el nuevo registro.</param>
        /// <param name="descripcion">La descripción del evento a registrar.</param>
        /// <param name="clase">La clase a la cual pertenece el método que produjo el evento.</param>
        ...
        /// <summary>
        /// Genera un nuevo registro de información en el Log.
        /// </summary>
        /// <param name="logger">El logger que almacenará el nuevo registro.</param>
        /// <param name="descripcion">La descripción del evento a registrar.</param>
        /// <param name="clase">La clase a la cual pertenece el método que produjo el evento.</param>
        ...
        /// <summary>
        /// Genera un nuevo registro de éxito en el Log.
        /// </summary>
        /// <param name="logger">El logger que almacenará el nuevo registro.</param>
        /// <param name="descripcion">La descripción del evento a registrar.</param>
        /// <param name="clase">La clase a la cual pertenece el método que produjo el evento.</param>
        ...
        /// <summary>
        /// Genera un nuevo registro en el Log.
        /// </summary>
        /// <param name="logger">El logger que almacenará el nuevo registro.</param>
        /// <param name="descripcion">La descripción del evento a registrar.</param>
        /// <param name="clase">La clase a la cual pertenece el método que produjo el evento.</param>
